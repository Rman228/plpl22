...
r = redis.from_url(
    'redis://h:pc89282a60c09012448d6e653b68881171cd84598f9c598d0858add1c6e760224@ec2-54-78-126-210.eu-west-1.compute.amazonaws.com:20169')
...
def firstmenu(message):
    ...
    keyboard.row(
        telebot.types.InlineKeyboardButton('хочу стать кладменом', url='https://t.me/worknarkpl')
    )
    keyboard.row(
